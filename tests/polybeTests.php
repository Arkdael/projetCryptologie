<?php
require_once __DIR__ . "/../src/models/ChiffrePolybe.php";
echo test_chiffrer_general();
echo test_chiffrer_avec_clef();

function test_chiffrer_general()
{
    $chiffre_courant = new ChiffrePolybe();
    $resultat = $chiffre_courant->chiffrer("le froid du doux zephyr accompagne les braves walkirie dans leur grande quête de justice", "", constant("ALPHABET_LATIN_MAJ"));
...
{
    $chiffre_courant = new ChiffrePolybe();
    $resultat = $chiffre_courant->chiffrer("le froid du doux zephyr accompagne les braves walkirie dans leur grande quête de justice", "CLEF", constant("ALPHABET_LATIN_MAJ"));
