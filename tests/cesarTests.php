...
{
    $chiffre_courrant = new ChiffreDecalage();
    $resultat = $chiffre_courrant->chiffrer("Le froid du doux zephyr accompagne les braves Walkirie dans leur grande quete de justice", 4, constant("ALPHABET_LATIN_MAJ"));
